            ...
            <tr>
              <td valign="top" class="em_aside">
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
                    <td  align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#5a8d3e;">COTIZACION ACEPTADA POR {{$cotizacion->nombre}}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td style="font-family:'Open Sans', Arial, sans-serif; font-size:15px; line-height:22px; color:#000">
                        <pre>Cordial saludo , 
                          ...
                          {{$cotizacion->nombre}} ha aceptado la cotizacion
                        ...
                        <tr>
                          ...
                          <td align="center" valign="top">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                              ...
                              <tr>
                                <td   align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:18px; font-weight:bold; line-height:20px; text-transform:uppercase; color:#5a8d3e;"><a href="#" target="_blank" style="color:#5a8d3e; text-decoration:none;"> PARA VER ESTA COTIZACÓN</a></td>
                              </tr>
                              <tr>
                                  ...
                                  <table width="400" border="0" cellspacing="0" cellpadding="0" align="center" class="em_wrapper" style="max-width:200px;">
                                    <tr>
                                      ...
                                      <td  width="45" bgcolor="#5a8d3e" height="45" align="center" style="font-family:'Open Sans', Arial, sans-serif; font-size:17px; font-weight:bold; color:#ffffff;">
                                        ...
                                        <a href="https://admin.amazoniacl.com/terceros/ver/<?php echo $cotizacion['tercero_id']?>" target="_blank" style="color:#ffffff; text-decoration:none;"> CLIC AQUÍ</a>
