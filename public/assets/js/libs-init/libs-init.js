...
CRUMINA.Bootstrap = function () {
	 ...
	 * https://v4-alpha.getbootstrap.com/getting-started/introduction/
	 * ---------------------------*/
	var date_select_field = $('.class_datetimepicker');
	/*moment.locale('uk');*/
	...
	maps: {
		mapUSA: {
			config: {
				id: 'map',
				map: {
					center: new L.LatLng(2.9092204, -75.2777199),
					zoom: 15,
					maxZoom: 18,
	...
	init: function () {
		...
		for (var key in this.maps) {
			...
			data.markers.forEach(function (item) {
				data.config.icon['iconUrl'] = './assets/img/page/' + item.icon;
